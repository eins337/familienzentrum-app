            ...
            children: [
              ...
              NCard(
                ...
                child: Column(
                  ...
                  children: [
                    const Text('ÜBERGREIFEND', style: TextStyle(fontSize: 10, letterSpacing: 1.1, color: AppColors.accent, fontWeight: FontWeight.w500)),
                    ...
                    for (final t in const ['Elternbeirat', 'Vorschulkinder 2026', 'Familientreff am Samstag'])
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Container(width: 5, height: 5, decoration: const BoxDecoration(shape: BoxShape.circle, color: AppColors.accent)),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Text(groupInitial(groupId), style: const TextStyle(fontFamily: 'Inter', fontWeight: FontWeight.w500, fontSize: 14, color: AppColors.bg)),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(name, style: const TextStyle(fontFamily: 'Inter', fontWeight: FontWeight.w500, fontSize: 15, color: AppColors.text)),
                Text('$childCount Kinder$teamLabel', style: const TextStyle(fontSize: 11.5, color: AppColors.neutral400), overflow: TextOverflow.ellipsis),
              ],
            ),
          ),
        ],
